...
var sapInstallerLink="http://localhost:8080/3DViewer/sapinstaller/VEVIEWERCOMP01_0.EXE";
...
function getSystemConfiguration(){
	...
	}else if ($.browser.webkit && navigator.userAgent.match(/Chrome/)){
		alert("chrome");
...
function is3dViewerInstalled(){
	...
	try{
		...
		alert("sapViewer==="+sapViewer);
		var viewer3dVersionNum = sapViewer.Version;
...
function initialize(){
	...
	if (systemConfig==null || !systemConfig.isViewer3dInstalled){
		document.getElementById("viewer3dInstallerDiv").style.visibility='visible';
