...
$(document).ready(function() {
 ...
 /* $[ "ui" ][ "autocomplete" ].prototype["_renderItem"] = function( ul, item) {
	...
	$(document).on('click', '#searchSubmit', function() {
		...
		// $('#from').attr("action","specificSearchCatalog.action").submit();
		 var searchWord = $("#keyword").val();
		 
		  //$('#from').attr("action","specificSearchCatalog.action");
			$("#catalog1").dataTable( {
				"retrieve": true,
				"serverSide": true,
				"searching": false,
			    ...
			    "fnDrawCallback": function () {
			  	 ...
			  	 //"sAjaxSource": $('#from').attr("action","specificSearchCatalog.action"),
			   
			    "sAjaxSource": "specificSearchCatalog.action?search="+searchWord,
		...
		<table width="70%"
			...
			<tr>
				<td>
					...
					<table id="catalog1" class="display" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Catalog Name</th>
								<th>Engineering Description</th>
