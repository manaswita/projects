...
<body>
<center><img src=../images/pizzaMenuHeading.gif></center>
<h2 align="center">Choose many to one and get happiness a ton!! </h2>
<script type="text/javascript">
function submitform(value)
{
	
    var url='toppingList.action?pizzaName='+value;
...
<s:form >
	...
	<tr >
	 ...
	 <tr  class="regtxt">
		 	<td class="regtxtLegals a:link">
		 	          
                	<%--  <a href="javascript: submitform()"><s:property value="key" />
                 	</a> --%>
  			   <a href="#" onclick="submitform('<s:property value="key" />')"><s:property value="key" />
  			   			<%
                ...
                <s:iterator value="value">
                 	<td >
                  	 ...
                  	 <td class="inputHeaders">
                   		<s:property value="values[1]"/>
                   	</td>
                   
                  	 <td class="inputHeaders">
                  		 <s:property value="values[2]"/>
                  	 </td>
